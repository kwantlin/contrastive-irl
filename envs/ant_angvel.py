...
class AntAngVel(PipelineEnv):
    def __init__(
        ...
        **kwargs,
        ...
        self.goal_indices = jnp.array([18, 19, 20])
    ...
    def step(self, state: State, action: jax.Array) -> State:
        ...
        def calculate_dist(p_state: base.State):
            ...
            return dist, ang_vel_error

        dist, ang_err = calculate_dist(pipeline_state)
        old_dist, _ = calculate_dist(pipeline_state0)
