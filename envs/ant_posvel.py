...
class AntPosVel(PipelineEnv):
    def __init__(
        ...
        **kwargs,
        ...
        self.goal_indices = jnp.array([0, 1, 2, 15, 16, 17])
    ...
    def reset(self, rng: jax.Array) -> State:
        ...
        rng, target_pos, target_vel = self._random_target(
            rng_target
        )
        target = {
            "pos": target_pos,
    ...
    def step(self, state: State, action: jax.Array) -> State:
        ...
        def calculate_dist(p_state: base.State):
            ...
            return dist, pos_error, vel_error

        dist, pos_err,  vel_err = calculate_dist(pipeline_state)
        old_dist, _, _ = calculate_dist(pipeline_state0)
    ...
    def _random_target(self, rng: jax.Array) -> Tuple[jax.Array, ...]:
        ...
        return rng, target_pos, target_vel
